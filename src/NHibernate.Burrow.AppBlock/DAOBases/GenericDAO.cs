...
namespace NHibernate.Burrow.AppBlock.DAOBases
{
    ...
    /// </remarks>
    public class GenericDAO<ReturnT> : IGenericDAO<ReturnT> where ReturnT : IEntity

    {
        readonly System.Type _NHEntityType;

        #region Constructors

        /// <summary>
        ///     Constructs a GenericDAO whose <typeparamref name="ReturnT" /> is different from the mapped entity type in
        ///     NHibernate
        /// </summary>
        /// <param name="entityTypeMapped"></param>
        /// <remarks>
        ///     for example, you can use an unmapped interface as <typeparamref name="ReturnT" /> and a mapped implementation type
        ///     as the entityTypeMapped
        /// </remarks>
        ...
        protected IStatelessSession StatelessSession
        {
            ...
            {
                return
                    new BurrowFramework().GetSessionFactory(_NHEntityType).
        ...
        protected IQuery CreateQuery(string queryString)
        {
            ...
            if (DefaultCacheable)
            {
                retVal.SetCacheable(DefaultCacheable).
                    SetCacheRegion(DefaultCacheRegion);
            }
            return retVal;
        }
        ...
        /// <returns></returns>
        protected static IList<ReturnT> PaginatedQuery(IQuery q, int startRow,
            int pageSize)
        {
        ...
        /// <returns></returns>
        protected ICriteria CreateCriteria(Order odr,
            IEnumerable<ICriterion> criterion)
        {
        ...
        /// <returns></returns>
        /// <remarks>
        ///     This pagination signature is designed to work with ASP.NET ObjectDataSource, for more advanced pagination, please
        ///     consider NHiberante.Burrow.Util.Pagination.IPaginator, NHiberante.Burrow.Util
        /// </remarks>
        protected IList<ReturnT> Find(int startRow, int pageSize,
            string sortExpression, ICriteria c)
        {
        ...
        /// </remarks>
        protected IList<ReturnT> Find(int startRow, int pageSize,
            string sortExpression, params ICriterion[] crit)
        {
        ...
        /// </remarks>
        protected IList<ReturnT> Find(int startRow, int pageSize,
            string sortExpression, ICollection<ICriterion> crit)
        {
            return Find(startRow, pageSize, sortExpression, CreateCriteria(crit));
        }
        ...
        {
            var retval = (ReturnT) Session.Load(_NHEntityType, id);
            return retval;
        }
        ...
        public IList<ReturnT> FindByExample(ReturnT exampleInstance,
